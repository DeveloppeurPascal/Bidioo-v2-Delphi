...
>
> Maintenance of this project has been moved to Codeberg at https://codeberg.org/Gamolf/Bidioo-v2-Delphi
>
...
> [!NOTE]
> To open or work on a ticket for this project, go to https://codeberg.org/Gamolf/Bidioo-v2-Delphi/issues
> To make a PULL REQUEST on this project, go to https://codeberg.org/Gamolf/Bidioo-v2-Delphi/pulls
> For any other information or to contact me, you can also visit the project website at https://bidioo.gamolf.fr or its devlog at https://developpeur-pascal.fr/bidioo.html
> This code repository will be archived once the migration is complete and will no losnger be updated on GitHub.

Bidioo is a match-3 video game with unusual features that allow players to choose whether to play short or long games.

The first version was developed in 2013 with [App Game Kit](https://www.appgamekit.com/) in AGK Basic. [Its source codes](https://github.com/DeveloppeurPascal/Bidioo-v1-AppGameKit) are available.
...
Visit [the Bidioo website](https://bidioo.gamolf.fr) to download the compiled version, learn more about how it works, access videos and articles, find out about the different versions available and their features, contact user support...
...
To download this code repository, we recommend using "git", but you can also download a ZIP file directly from [its GitHub repository](https://codeberg.org/Gamolf/Bidioo-v2-Delphi).
...
Documentation is exported in HTML by [DocInsight](https://devjetsoftware.com/products/documentation-insight/) or [PasDoc](https://pasdoc.github.io) to the /docs folder of the repository. You can also [access it online](https://developpeurpascal.github.io/Bidioo-v2-Delphi) through the hosting offered by GitHub Pages.

Further information (tutorials, articles, videos, FAQ, talks and links) can be found on [the project website](https://bidioo.gamolf.fr) or [the project devlog](https://developpeur-pascal.fr/bidioo.html).
...
If you detect any anomalies on earlier versions, please don't hesitate to [report them](https://codeberg.org/Gamolf/Bidioo-v2-Delphi/issues) so that I can test and try to correct or provide a workaround.
...
If you want an answer from the project owner the best way to ask for a new feature or report a bug is to go to [the GitHub repository](https://codeberg.org/Gamolf/Bidioo-v2-Delphi) and [open a new issue](https://codeberg.org/Gamolf/Bidioo-v2-Delphi/issues).
