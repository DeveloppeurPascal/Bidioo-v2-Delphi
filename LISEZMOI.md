...
>
> La maintenance de ce projet est déplacée vers Codeberg sur https://codeberg.org/Gamolf/Bidioo-v2-Delphi
>
...
> [!NOTE]
> Pour ouvrir ou intervenir sur un ticket de ce projet, rendez-vous sur https://codeberg.org/Gamolf/Bidioo-v2-Delphi/issues
> Pour faire un PULL REQUEST sur ce projet, rendez-vous sur https://codeberg.org/Gamolf/Bidioo-v2-Delphi/pulls
> Pour toute autre information ou me contacter vous pouvez aussi consulter le site Internet du projet sur https://bidioo.gamolf.fr ou son devlog sur https://developpeur-pascal.fr/bidioo.html
> Ce dépôt de code sera archivé une fois la migration terminée et ne bénéficiera plus de mise à jour sur GitHub.

Bidioo est un jeu vidéo de type match-3 avec des fonctionnalités inhabituelles autorisant des parties courtes ou longues au choix du joueur.

La première version avait été développée en 2013 avec [App Game Kit](https://www.appgamekit.com/) en AGK Basic. [Ses codes sources](https://github.com/DeveloppeurPascal/Bidioo-v1-AppGameKit) sont disponibles.
...
Consultez [le site de Bidioo](https://bidioo.gamolf.fr) pour télécharger sa version compilée, en savoir plus sur son fonctionnement, accéder à des vidéos et articles, connaître les différentes versions disponibles et leurs fonctionnalités, contacter le support utilisateurs...
...
Pour télécharger ce dépôt de code il est recommandé de passer par "git" mais vous pouvez aussi télécharger un ZIP directement depuis [son dépôt GitHub](https://codeberg.org/Gamolf/Bidioo-v2-Delphi).
...
L'export de la documentation est fait en HTML par [DocInsight](https://devjetsoftware.com/products/documentation-insight/) ou [PasDoc](https://pasdoc.github.io) vers le dossier /docs du dépôt. Vous y avez aussi [accès en ligne](https://developpeurpascal.github.io/Bidioo-v2-Delphi) grâce à l'hébergement offert par GitHub Pages.

D'autres informations (tutoriels, articles, vidéos, FAQ, présentations et liens) sont disponibles sur [le site web du projet](https://bidioo.gamolf.fr) ou [le devlog du projet](https://developpeur-pascal.fr/bidioo.html).
...
Si vous détectez des anomalies sur des versions antérieures n'hésitez pas à [les rapporter](https://codeberg.org/Gamolf/Bidioo-v2-Delphi/issues) pour que je teste et tente de corriger ou fournir un contournement.
...
Si vous voulez une réponse du propriétaire de ce dépôt la meilleure façon de procéder pour demander une nouvelle fonctionnalité ou signaler une anomalie est d'aller sur [le dépôt de code sur GitHub](https://codeberg.org/Gamolf/Bidioo-v2-Delphi) et [d'ouvrir un ticket](https://codeberg.org/Gamolf/Bidioo-v2-Delphi/issues).
